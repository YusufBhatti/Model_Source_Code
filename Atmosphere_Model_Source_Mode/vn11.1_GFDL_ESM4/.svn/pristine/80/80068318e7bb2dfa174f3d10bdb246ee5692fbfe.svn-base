...
TYPE(asad_flux_defn), PARAMETER, PUBLIC ::                       &
                            asad_aerosol_chem_online(20) = (/    &
asad_flux_defn('RXN',50136,'B',.FALSE.,0,3,                      &
(/'DMS       ','OH        '/),                                   &
(/'SO2       ','          ','          ','          '/)),        &
asad_flux_defn('RXN',50137,'B',.FALSE.,0,4,                      &
(/'DMS       ','OH        '/),                                   &
(/'SO2       ','HCHO      ','          ','          '/)),        &
asad_flux_defn('RXN',50138,'B',.FALSE.,0,5,                      &
(/'DMS       ','NO3       '/),                                   &
(/'SO2       ','HNO3      ','HCHO      ','          '/)),        &
asad_flux_defn('RXN',50139,'T',.FALSE.,0,3,                      &
(/'SO2       ','OH        '/),                                   &
(/'H2SO4     ','          ','          ','          '/)),        &
...
TYPE(asad_flux_defn), PARAMETER, PUBLIC ::                       &
                         asad_aerosol_chem_strattrop(20) = (/    &
asad_flux_defn('RXN',50136,'B',.FALSE.,0,3,                      &
(/'DMS       ','OH        '/),                                   &
(/'SO2       ','          ','          ','          '/)),        &
asad_flux_defn('RXN',50137,'B',.FALSE.,0,4,                      &
...
TYPE(asad_flux_defn), PUBLIC :: asad_aerosol_chem(20)
