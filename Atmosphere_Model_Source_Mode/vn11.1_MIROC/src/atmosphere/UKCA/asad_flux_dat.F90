...
TYPE(asad_flux_defn), PARAMETER, PUBLIC ::                       &
                            asad_aerosol_chem_online(19) = (/    &
asad_flux_defn('RXN',50137,'B',.FALSE.,0,5,                      &
(/'DMS       ','OH        '/),                                   &
(/'SO2       ','MeOO      ','HCHO      ','          '/)),        &
...
TYPE(asad_flux_defn), PARAMETER, PUBLIC ::                       &
                         asad_aerosol_chem_strattrop(19) = (/    &
asad_flux_defn('RXN',50137,'B',.FALSE.,0,5,                      &
(/'DMS       ','OH        '/),                                   &
(/'SO2       ','MeOO      ','HCHO      ','          '/)),        &
asad_flux_defn('RXN',50138,'B',.FALSE.,0,5,                      &
...
TYPE(asad_flux_defn), PUBLIC :: asad_aerosol_chem(19)
