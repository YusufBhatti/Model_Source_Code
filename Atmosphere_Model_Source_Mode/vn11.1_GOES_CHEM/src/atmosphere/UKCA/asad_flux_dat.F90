...
TYPE(asad_flux_defn), PARAMETER, PUBLIC ::                       &
                            asad_aerosol_chem_online(21) = (/    &
asad_flux_defn('RXN',50135,'B',.FALSE.,0,5,                      &
(/'DMS       ','OH        '/),                                   &
(/'SO2       ','MeOO      ','HCHO      ','          '/)),        &
...
(/'DMS       ','NO3       '/),                                   &
(/'SO2       ','HNO3      ','MeOO      ','HCHO      '/)),        &
asad_flux_defn('RXN',50138,'H',.FALSE.,0,3,                      &
(/'SO2       ','HOBr      '/),                                   &
(/'NULL3     ','          ','          ','          '/)),        &
asad_flux_defn('RXN',50139,'H',.FALSE.,0,3,                      &
(/'SO2       ','HOBr      '/),                                   &
(/'NULL4     ','          ','          ','          '/)),        &
...
TYPE(asad_flux_defn), PARAMETER, PUBLIC ::                       &
                         asad_aerosol_chem_strattrop(21) = (/    &
asad_flux_defn('RXN',50135,'B',.FALSE.,0,5,                      &
(/'DMS       ','OH        '/),                                   &
(/'SO2       ','MeOO      ','HCHO      ','          '/)),        &
asad_flux_defn('RXN',50136,'B',.FALSE.,0,4,                      &
...
TYPE(asad_flux_defn), PUBLIC :: asad_aerosol_chem(21)
